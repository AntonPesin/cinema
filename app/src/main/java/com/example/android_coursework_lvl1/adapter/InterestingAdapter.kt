...
class InterestingAdapter(private var movies: List<MovieModel>) : RecyclerView.Adapter<InterestingMoviesViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): InterestingMoviesViewHolder {
        return InterestingMoviesViewHolder(
    ...
    override fun onBindViewHolder(holder: InterestingMoviesViewHolder, position: Int) {
